" custom airline theme customized by @amiel
...
let s:I3 = [s:gui_blue, s:gui_dark_gray, s:cterm_blue, s:cterm_dark_gray]
let g:airline#themes#custom#palette.insert = airline#themes#generate_color_map(s:I1, s:N2, s:I3)
...
let g:airline#themes#custom#palette.replace = {
      ...
      \ }
let g:airline#themes#custom#palette.replace_modified = copy(g:airline#themes#custom#palette.insert_modified)
...
let g:airline#themes#custom#palette.visual = airline#themes#generate_color_map(s:V1, s:N2, s:V3)
